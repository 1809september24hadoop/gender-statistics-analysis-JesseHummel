...
public class FemaleEmploymentTest {
	...
	@Before
	public void setup(){
		FemaleMapper mapper = new FemaleMapper();
	...
	public void testMapper(){
		mapDriver.withInput(new LongWritable(1), new Text("\"United States\",\"WLD\",\"School enrollment, primary, female (% gross)\",\"SL.EMP.TOTL.SP.FE.ZS\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"100.0\",\"50.0\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\","));
	...
	public void testMapReduce(){
		...
		mapReduceDriver.withInput(new LongWritable(1), new Text("\"United States\",\"WLD\",\"School enrollment, primary, female (% gross)\",\"SL.EMP.TOTL.SP.FE.ZS\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"48.478942\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"\",\"46.444118\","));
		
		mapReduceDriver.addOutput(new Text("United States"), new FloatWritable(-0.12717651900638125f));
